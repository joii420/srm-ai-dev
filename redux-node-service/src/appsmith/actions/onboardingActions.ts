...
export const updateLeftMenuCollapse = (isLeftMenuCollapse: boolean) => {
  return {
    type: ReduxActionTypes.UPDATE_LEFT_MENU_COLLAPSE,
    payload: { isLeftMenuCollapse },
  }
}

export const updateSearchModalVisible = (isSearchModalVisible: boolean) => {
  return {
    type: ReduxActionTypes.UPDATE_SEARCH_MODAL_VISIBLE,
    payload: { isSearchModalVisible },
  }
}

export const updateFavoritesMenus = (favoritesMenus: any[]) => {
  return {
    type: ReduxActionTypes.UPDATE_FAVORITE_MENU,
    payload: { favoritesMenus },
  }
}
