...
export default class LibraryApi extends Api {
  ...
  static async getCustomLibraries() {
    const url = "/script-engine/com/module/completed/list";
    return axios.get(url);
  }

  static async getPageModalList(appCode: string) {
    const url = `/script-engine/edit/modal/list?appCode=${appCode}`;
    return axios.get(url);
  }
}
