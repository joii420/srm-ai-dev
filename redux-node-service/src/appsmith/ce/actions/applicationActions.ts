...
import type { IconNames } from "../../stubs/toast";
...
// 修改:evalMode属性更新1
export const updatePageEvalMode = (data: object) => {
  return {
    type: ReduxActionTypes.UPDATE_PAGE_EVAL_MODE,
    payload: {
      ...data,
    },
  };
};
// 修改:updateConnectionsData更新
export const updateConnectionsData = (data: object) => {
  return {
    type: ReduxActionTypes.UPDATE_CONNECTIONS_DATA,
    payload: {
      ...data,
    },
  };
};
export const updateIsInitEnd = (data: object) => {
  return {
...
export const allCompleteLoadingSuccess = () => {
  return {
    type: ReduxActionTypes.ALL_COMPLETE_LOADING_SUCCESS,
  };
};
...
export const changeForceShowModal = (forceShowModal: boolean) => {
  return {
    type: ReduxActionTypes.FORCE_SHOW_MODAL,
    payload: {
      forceShowModal,
    },
  };
