...
export const GLOBAL_FUNCTIONS = {
  ...
  getWidgets: {
    "!doc": "Action to get all widgets in current page",
    "!type": "fn() -> +Promise[:t=[!0.<i>.:t]]",
  },
  set_toolbar: {
    "!doc": "Action to update toolbar config",
    "!type": "fn(config: any) -> +Promise[:t=[!0.<i>.:t]]",
  },
  get_toolbar: {
    "!doc": "Action to update toolbar config",
    "!type": "fn() -> +Promise[:t=[!0.<i>.:t]]",
  ...
  set_browser: {
    "!doc": "Action to update leftSidebar config",
    "!type": "fn(config: any) -> +Promise[:t=[!0.<i>.:t]]",
  },
  setLoading: {
    "!doc": "Action to show loading modal",
    "!type": "fn(params: unknow) -> +Promise[:t=[!0.<i>.:t]]",
  },
  // 修改处
  showProgressBar: {
    "!doc": "Action to show progress bar",
    "!type": "fn(action: string, data: any) -> +Promise[:t=[!0.<i>.:t]]",
  },
  showQuery: {
    "!doc": "Action to show query modal",
    "!type": "fn(params: unknow) -> +Promise[:t=[!0.<i>.:t]]",
  },
  closeQuery: {
    "!doc": "Action to close query modal",
    "!type": "fn(params: unknow) -> +Promise[:t=[!0.<i>.:t]]",
  },
  showCommonDialog: {
    "!doc": "Action to show CommonDialog modal",
    "!type": "fn(params: unknow, type: string) -> +Promise",
  },
  showMessage: {
    "!doc": "Action to show message modal",
    "!type":
      "fn(params: unknow, type: string, type2: string) -> +Promise[:t=[!0.<i>.:t]]",
  },
  showMaterials: {
    "!doc": "Action to show message modal",
    "!type": "fn(params: unknow, type: string) -> +Promise[:t=[!0.<i>.:t]]",
  },
  showPrint: {
    "!doc": "Action to show query modal",
    "!type": "fn(params: unknow) -> +Promise[:t=[!0.<i>.:t]]",
  ...
  operateWidget: {
    "!doc": "Operate Widget",
    "!type":
      "fn(widgetName: string, method: string, params: unknown) -> +Promise[:t=[!0.<i>.:t]]",
  },
  operateWidgetSync: {
    "!doc": "Operate Widget Sync",
    "!type": "fn(widgetName: string, method: string, params: unknown) -> any",
  },
  setInterval: {
    "!url":
  ...
  windowMessageListener: {
    "!doc": "listen message from parent window",
    "!type": "fn(domain: string, callback: fn) -> void",
  },
  unlistenWindowMessage: {
    "!doc": "unlisten message from parent window",
...
export const ternDocsInfo: Record<string, any> = {
  showProgressBar: {
    exampleArgs: [
      "'open', {type:'Linear|Circular',maximum:100,minimum:0})",
      "'close', {}",
      "'set', {'value':40}",
    ],
  },
