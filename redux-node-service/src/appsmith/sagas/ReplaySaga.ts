...
export function* openPropertyPaneSaga(replay: any) {
  try {
    ...
    // Node.js: skip DOM scroll operation
    if (typeof document !== "undefined" && document.getElementById) {
      scrollWidgetIntoView(replayWidgetId, ps);
    }
    ...
    // Node.js: skip DOM flash operation
    if (typeof document !== "undefined" && document.getElementById) flashElementsById(
      btoa(
...
export function* postUndoRedoSaga(replay: any) {
  try {
    ...
    // Node.js: skip DOM scroll operation
    if (typeof document !== "undefined" && document.getElementById) {
      scrollWidgetIntoView(widgetIds[0], ps);
    }
  } catch (e) {
    log.error(e);
    console.error(e);
