...
function* deleteTabChildSaga(
  ...
  const { index, label, widgetId, type } = deleteChildTabAction.payload;
  ...
  if (tabWidget && tabWidget.parentId) {
    ...
    const tabsArray: any = orderBy(
      Object.values(
        tabParentWidget.tabsObj ??
          tabParentWidget.panelsObj ??
          tabParentWidget.splitterObj ??
          tabParentWidget[type],
      ),
      "index",
      "asc",
    );
    ...
    if (updatedDslObj) {
      ...
      let parentUpdatedWidgets = {};
      // if (tabParentWidget.tabsObj) {
      ...
      //   };
      // }
      // if (tabParentWidget.splitterObj) {
      //   parentUpdatedWidgets = {
      //     ...finalWidgets,
      //     [tabParentWidget.widgetId]: {
      //       ...finalWidgets[tabParentWidget.widgetId],
      //       splitterObj: updatedObj,
      //     },
      //   };
      // }
      // if (tabParentWidget.panelsObj) {
      //   parentUpdatedWidgets = {
      //     ...finalWidgets,
      //     [tabParentWidget.widgetId]: {
      //       ...finalWidgets[tabParentWidget.widgetId],
      //       panelsObj: updatedObj,
      //     },
      //   };
      // }
      // if (tabParentWidget.holidayObj) {
      //   parentUpdatedWidgets = {
      //     ...finalWidgets,
      //     [tabParentWidget.widgetId]: {
      //       ...finalWidgets[tabParentWidget.widgetId],
      //       holidayObj: updatedObj,
      //     },
      //   };
      // }
      // type为undefined时（即非甘特图组件中
      if (!type) {
        tabsKeysArray.some((tabKey: any) => {
          if (tabParentWidget[tabKey]) {
            parentUpdatedWidgets = {
              ...finalWidgets,
              [tabParentWidget.widgetId]: {
                ...finalWidgets[tabParentWidget.widgetId],
