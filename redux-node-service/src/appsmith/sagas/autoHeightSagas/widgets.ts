...
import { Directly_Mutate_DOM_Nodes_Event } from "constants/EventConstants";
...
export function* updateWidgetAutoHeightSaga(
  ...
  if (Object.keys(widgetsToUpdate).length > 0) {
    ...
    const ps = yield select(getPagePs);
    // TODO: 【临时修改】ui处理，忽略
    // Node.js: skip DOM mutation, preserve calculation logic
    ...
    //     ps,
    //   );
    //   GlobalEvent.trigger(Directly_Mutate_DOM_Nodes_Event, enhancedWidgetUpdates);
    // }
  }
