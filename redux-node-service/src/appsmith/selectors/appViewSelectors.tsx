...
export const getIsAllLoading = createSelector(
  getAppViewState,
  (view: AppViewReduxState) => view.allLoading,
);

export const getIsGlobalLoading = createSelector(
  getAppViewState,
  (view: AppViewReduxState) => view.globalLoading,
);

export const getIsInitAfterExecuteWidgetFns = createSelector(
  getAppViewState,
  (view: AppViewReduxState) => view.isInitAfterExecuteWidgetFns,
);
