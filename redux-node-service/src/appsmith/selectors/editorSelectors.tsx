...
export const getCheckStatus = (state: AppState) => state.ui.editor.checkData;

export const getHistoryData = (state: AppState) => state.ui.editor.historyData;
...
export const getIsModelWorkspace = (state: AppState) => {
  return state.ui.applications.currentApplication?.isModelWorkspace;
}
...
export const getViewModePageListFn = (
  pageList: PageListReduxState["pages"],
  currentPageId?: string,
) => {
  if (currentPageId) {
    const currentPage = pageList.find((page) => page.pageId === currentPageId);
...
export const getWorkspaceHeight = (state: AppState) =>
  state.ui.mainCanvas.workspaceHeight;
