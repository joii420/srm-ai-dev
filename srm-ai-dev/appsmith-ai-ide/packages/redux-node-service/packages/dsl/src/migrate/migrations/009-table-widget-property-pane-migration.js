...
exports.tableWidgetPropertyPaneMigrations = exports.getAllTableColumnKeys = void 0;
/* eslint-disable @typescript-eslint/no-explicit-any */
const cloneDeep_1 = __importDefault(require("lodash/cloneDeep"));
const isString_1 = __importDefault(require("lodash/isString"));
const utils_1 = require("../utils");
const getAllTableColumnKeys = (tableData) => {
    const columnKeys = [];
    if (tableData) {
...
exports.getAllTableColumnKeys = getAllTableColumnKeys;
const tableWidgetPropertyPaneMigrations = (currentDSL) => {
    currentDSL.children = currentDSL.children?.map((_child) => {
        let child = (0, cloneDeep_1.default)(_child);
        ...
        if (child.type === "TABLE_WIDGET") {
            ...
            if (child.tableData.length) {
                ...
                if (!(0, isString_1.default)(tableData) &&
                    dynamicBindingPathList?.findIndex((item) => item.key !== "tableData")) {
                    // Get the list of column ids
                    tableColumns = (0, exports.getAllTableColumnKeys)(tableData);
                }
                else {
            ...
            primaryColumns.forEach((accessor, index) => {
                // Get the column type from the columnTypeMap
                let columnType = columnTypeMap && columnTypeMap[accessor]
                ...
                const column = {
                    ...
                    width: columnSizeMap && columnSizeMap[accessor]
                    ...
                    label: columnNameMap && columnNameMap[accessor]
            ...
            let dynamicTriggerPathList = child.dynamicTriggerPathList || [];
            ...
            columnActions.forEach((action, index) => {
                const column = {
                    index: child.primaryColumns.length + index,
                    width: 150,
            ...
            if (Object.keys(updatedDerivedColumns).length) {
                dynamicTriggerPathList = dynamicTriggerPathList.filter((triggerPath) => {
            ...
            child = (0, exports.tableWidgetPropertyPaneMigrations)(child);
        }
        return child;
    });
    return currentDSL;
};
exports.tableWidgetPropertyPaneMigrations = tableWidgetPropertyPaneMigrations;
//# sourceMappingURL=009-table-widget-property-pane-migration.js.map