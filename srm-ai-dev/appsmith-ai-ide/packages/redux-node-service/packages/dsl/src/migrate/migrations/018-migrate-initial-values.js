...
exports.migrateInitialValues = void 0;
const migrateInitialValues = (currentDSL) => {
    currentDSL.children = currentDSL.children?.map((child) => {
        if (child.type === "INPUT_WIDGET") {
            ...
            child = (0, exports.migrateInitialValues)(child);
        }
        return child;
    });
    return currentDSL;
};
exports.migrateInitialValues = migrateInitialValues;
//# sourceMappingURL=018-migrate-initial-values.js.map