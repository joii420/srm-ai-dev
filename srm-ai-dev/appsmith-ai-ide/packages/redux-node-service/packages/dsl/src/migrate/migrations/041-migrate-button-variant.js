...
exports.migrateButtonVariant = void 0;
var ButtonVariantTypes;
(function (ButtonVariantTypes) {
    ButtonVariantTypes["PRIMARY"] = "PRIMARY";
    ButtonVariantTypes["SECONDARY"] = "SECONDARY";
    ButtonVariantTypes["TERTIARY"] = "TERTIARY";
})(ButtonVariantTypes || (ButtonVariantTypes = {}));
const migrateButtonVariant = (currentDSL) => {
    ...
    if (currentDSL.children && currentDSL.children.length) {
        currentDSL.children = currentDSL.children.map((child) => (0, exports.migrateButtonVariant)(child));
    }
    return currentDSL;
};
exports.migrateButtonVariant = migrateButtonVariant;
//# sourceMappingURL=041-migrate-button-variant.js.map