...
//新加
export const buttonSaveAndSetTimeSave =
  (): ReduxAction<SetWidgetDynamicPropertyPayload> => {
    return {
      type: ReduxActionTypes.BUTTON_SAVE_AND_SET_TIME_SAVE,
      payload: {
        widgetId: "",
        propertyPath: "",
        isDynamic: false,
...
export const generateUiByDsl = (dsl: any) => {
  return {
    type: ReduxActionTypes.GENERATE_UI_BY_DSL,
    payload: {
      dsl,
    },
  };
...
// 修改:调用系统全局方法
export const yeildExecuteActionTriggers = (
  trigger: any,
  eventType?: any,
  triggerMeta?: any,
  resolve?: any,
  ...
  return {
    type: ReduxActionTypes.EXECUTE_ACTION_TRIGGERS,
    payload: {
      widgetId: "",
      propertyPath: "",
      isDynamic: false,
...
// 修改:调用系统全局方法
export const triggerOperateWidgetByName = (
  dispatch: any,
  widgetName: string,
  method: any,
  params: any,
