...
// import PackageIDE from "pages/Editor/PackageIDE";
import PackageIDELoader from "pages/Editor/PackageIDE/loader";
import { PACKAGE_PATH } from "@appsmith/constants/routes/appRoutes";
import { put } from "redux-saga/effects";
import AppViewerLoaderWrapper from "pages/AppViewer/AppViewerLoaderWrapper";
...
export function Routes() {
  ...
  return (
    <Switch>
      <SentryRoute component={PackageIDELoader} path={PACKAGE_PATH} />
      ...
      <SentryRoute component={AppViewerLoaderWrapper} path={VIEWER_PATH_DEPRECATED} />
      <SentryRoute
        component={CustomWidgetBuilderLoader}
        exact
      ...
      <SentryRoute component={AppViewerLoaderWrapper} path={VIEWER_PATH} />
      <SentryRoute component={AppViewerLoaderWrapper} path={VIEWER_CUSTOM_PATH} />
      {/*
...
export default function AppRouter() {
  ...
  useEffect(() => {
    PerformanceTracker.stopAsyncTracking(
      PerformanceTransactionName.ROOT_TO_START_INIT,
    );
    //判断是否编辑模式
    const url = window.location.pathname;
    if (url.includes("application") || /\/edit(\/|$)/.test(url)) {
