...
const ActionTypes = {
  ...
  UPDATE_PAGE_EVAL_MODE: "UPDATE_PAGE_EVAL_MODE",
  UPDATE_IS_INIT_END: "UPDATE_IS_INIT_END",
  SET_BATCH_EVALUATED_TREE: "SET_BATCH_EVALUATED_TREE",
  ...
  EXECUTE_TRIGGER_NOWORK: "EXECUTE_TRIGGER_NOWORK",
  EXECUTE_TRIGGER_REQUEST: "EXECUTE_TRIGGER_REQUEST",
  EXECUTE_TRIGGER_REQUEST_SYNC: "EXECUTE_TRIGGER_REQUEST_SYNC",
  ...
  CREATE_PACKAGE_INIT: "CREATE_PACKAGE_INIT",
  ...
  CREATE_JS_MODULE_INIT: "CREATE_API_MODULE_INIT",
  CREATE_JS_MODULE_SUCCESS: "CREATE_API_MODULE_SUCCESS",
  ...
  REFACTOR_MODULE_INPUT_NAME_INIT: "REFACTOR_MODULE_INPUT_NAME_INIT",
  REFACTOR_MODULE_INPUT_NAME_SUCCESS: "REFACTOR_MODULE_INPUT_NAME_SUCCESS",
  REFACTOR_MODULE_NAME_INIT: "REFACTOR_MODULE_NAME_INIT",
  REFACTOR_MODULE_NAME_SUCCESS: "REFACTOR_MODULE_NAME_SUCCESS",
  ...
  BUTTON_SAVE_AND_SET_TIME_SAVE: "BUTTON_SAVE_AND_SET_TIME_SAVE",
  GENERATE_UI_BY_DSL: "GENERATE_UI_BY_DSL",
  EXECUTE_ACTION_TRIGGERS: "EXECUTE_ACTION_TRIGGERS",
  ...
  // 修改处
  SHOW_NAVIGATE_MODAL: "SHOW_NAVIGATE_MODAL",
  CLOSE_NAVIGATE_MODAL: "CLOSE_NAVIGATE_MODAL",

  UPDATE_TOOLBAR_CONFIG: "UPDATE_TOOLBAR_CONFIG",
  UPDATE_LEFTSIDEBAR_CONFIG: "UPDATE_LEFTSIDEBAR_CONFIG",
  PUT_STATE_FROM_APP_TO_DOC_LIST: "PUT_STATE_FROM_APP_TO_DOC_LIST",
  EXECUTE_ACTION_TO_DOC_LIST: "EXECUTE_ACTION_TO_DOC_LIST",
  UPDATE_DOC_LIST_SELECT_INDEX: "UPDATE_DOC_LIST_SELECT_INDEX",
  UPDATE_PATHDATA: "UPDATE_PATHDATA",
  UPDATE_CURRENTPATH: "UPDATE_CURRENTPATH",
  UPDATE_PREVPATH: "UPDATE_PREVPATH",
  UPDATE_LAYOUTDATA: "UPDATE_LAYOUTDATA",
  UPDATE_TOOLBAR: "UPDATE_TOOLBAR",
  ANCHOR_MENU: "ANCHOR_MENU",
  MORE_MENU: "MORE_MENU",
  UPDATE_HOMEPAGETEXT_CONFIG: "UPDATE_HOMEPAGETEXT_CONFIG",
  UPDATE_APPLICATIONDATA: "UPDATE_APPLICATIONDATA",
  SOCKET_CONFIG: "SOCKET_CONFIG",
  SOCKET_CONNECTED: "SOCKET_CONNECTED",
  SOCKET_OBJECT: "SOCKET_OBJECT",
  NAVIGATE_ERROR_PAGE: "NAVIGATE_ERROR_PAGE",
  PAGE_CONFIG_INFO: "PAGE_CONFIG_INFO",
  SET_LOADING: "SET_LOADING",
  // 修改处
  SHOW_PROGRESS_BAR: "SHOW_PROGRESS_BAR",
  SHOW_PREDEFINED_DIALOG: "SHOW_PREDEFINED_DIALOG",
  SET_UPDATES: "SET_UPDATES",
  SET_PAGE_CONTEXT: "SET_PAGE_CONTEXT",
  SHOW_QUERY: "SHOW_QUERY",
  CLOSE_QUERY: "CLOSE_QUERY",
  SHOW_COMMON_DIALOG: "SHOW_COMMON_DIALOG",
  UPDATE_COMMON_DIALOG: "UPDATE_COMMON_DIALOG",
  UPDATE_QUERY_PROPS: "UPDATE_QUERY_PROPS",
  UPDATE_MESSAGE_PROPS: "UPDATE_MESSAGE_PROPS",
  UPDATE_MULTILANG_PROPS: "UPDATE_MULTILANG_PROPS",
  UPDATE_PRINT_PROPS: "UPDATE_PRINT_PROPS",
  SHOW_MESSAGE: "SHOW_MESSAGE",
  SHOW_MATERIALS: "SHOW_MATERIALS",
  CLOSE_MESSAGE: "CLOSE_MESSAGE",
  SHOW_PRINT: "SHOW_PRINT",
  CLOSE_PRINT: "CLOSE_PRINT",
  STORE_CANVAS_LAYOUT_TEMP: "STORE_CANVAS_LAYOUT_TEMP",
  ALL_COMPLETE_LOADING: "ALL_COMPLETE_LOADING",
  ALL_COMPLETE_LOADING_SUCCESS: "ALL_COMPLETE_LOADING_SUCCESS",
  UPDATE_NOTIFICATION_PROPS: "UPDATE_NOTIFICATION_PROPS",
  UPDATE_OPENWINDOW_PROPS: "UPDATE_OPENWINDOW_PROPS",
  UPDATE_MESSAGE_NUM: "UPDATE_MESSAGE_NUM",
  UPDATE_MESSAGE_COUNT: "UPDATE_MESSAGE_COUNT",
  UPDATE_MESSAGE_TREE_DATA: "UPDATE_MESSAGE_TREE_DATA",
  UPDATE_TODO_NUM: "UPDATE_TODO_NUM",
  UPDATE_UNREAD_NUM: "UPDATE_UNREAD_NUM",
  START_GLOBAL_LOADING: "START_GLOBAL_LOADING",
  END_GLOBAL_LOADING: "END_GLOBAL_LOADING",
  END_INIT_EXEC_WIDGET_FNS: "END_INIT_EXEC_WIDGET_FNS",
  ...
  STORE_VALUE_STATIC: "STORE_VALUE_STATIC",
  ...
  INIT_HOME_VIEW_PAGE: "INIT_HOME_VIEW_PAGE",
  OPEN_NEW_VIEW_PAGE: "OPEN_NEW_VIEW_PAGE",
  CLOSE_VIEW_PAGE: "CLOSE_VIEW_PAGE",
  CLOSE_OTHER_VIEW_PAGE: "CLOSE_OTHER_VIEW_PAGE",
  CLOSE_ALL_VIEW_PAGE: "CLOSE_ALL_VIEW_PAGE",
  CHANGE_VIEW_PAGE: "CHANGE_VIEW_PAGE",
  UPDATE_VIEW_PAGE: "UPDATE_VIEW_PAGE",

  FORCE_SHOW_MODAL: "FORCE_SHOW_MODAL",

  CLOSE_DRAWER: "CLOSE_DRAWER",
  CREATE_DRAWER_INIT: "CREATE_DRAWER_INIT",
  SHOW_DRAWER: "SHOW_DRAWER",
  SHOW_DRAWER_BY_NAME: "SHOW_DRAWER_BY_NAME",

  UPDATE_LEFT_MENU_COLLAPSE: "UPDATE_LEFT_MENU_COLLAPSE",
  UPDATE_SEARCH_MODAL_VISIBLE: "UPDATE_SEARCH_MODAL_VISIBLE",

  UPDATE_FAVORITE_MENU: "UPDATE_FAVORITE_MENU",

  NODE_INIT_EDITOR_SUCCESS: "NODE_INIT_EDITOR_SUCCESS",
  NODE_UPDATE_JS_BODY_SUCCESS: "NODE_UPDATE_JS_BODY_SUCCESS",
  NODE_UPDATE_JS_BODY_ERROR: "NODE_UPDATE_JS_BODY_ERROR",
};
...
export const ReduxActionErrorTypes = {
  ...
  REFACTOR_MODULE_INPUT_NAME_ERROR: "REFACTOR_MODULE_INPUT_NAME_ERROR",
  REFACTOR_MODULE_NAME_ERROR: "REFACTOR_MODULE_NAME_ERROR",
...
export const WidgetReduxActionTypes: { [key: string]: string } = {
  ...
  WIDGET_DRAWER_RESIZE: "WIDGET_DRAWER_RESIZE",
};
