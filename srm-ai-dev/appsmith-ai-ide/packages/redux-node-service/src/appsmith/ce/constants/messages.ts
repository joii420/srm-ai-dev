...
export const PUBLISH_MENU_OPTION = () => "Publish";
export const PACKAGE_HEADER_TITLE = () => "Modules";
export const ADD_MODULE_TOOLTIP = () => "Add a new module";
export const CREATE_JS_MODULE = () => "JS Module";
export const CREATE_QUERY_MODULE = () => "Query Module";
export const UPDATE_PACKAGE_VIA_IMPORT_SETTING = {
...
export const EMPTY_MODULE_MAIN_TEXT = () => "No modules to display.";
export const EMPTY_MODULE_BUTTON_TEXT = () => "New module";
export const MODULE_INPUT_INVALID_NAME_ERROR = () =>
  "Input names can only contain alphanumeric and should start with an alphabet";
export const MODULE_INPUT_CONFLICT_NAME_ERROR = () =>
  "Input name should be unique.";
export const MODULE_INPUTS_FORM_HEADER = () => "Inputs";
export const MODULE_INPUTS_FORM_TIPS = () =>
  "Access the inputs defined below using the syntax";
export const MODULE_INPUTS_FORM_ADD_BUTTON_TEXT = () => "Add Input";
...
export const SET_TOOLBAR = () => `set toolbar config`;
export const GET_TOOLBAR = () => `get toolbar config`;

export const SET_BROWSER = () => `set application leftSidebar config`;
export const SET_LOADING = () => `Set Loading`;
// 修改处
export const SHOW_PROGRESS_BAR = () => `show progress bar`;
export const SHOW_QUERY = () => `Show query`;
export const SHOW_COMMON_DIALOG = () => `Show common dialog`;
export const SHOW_MESSAGE = () => `Show message`;
export const SHOW_MATERIALS = () => `Show materials`;
export const SHOW_PRINT = () => `Show print`;
...
export const OPERATE_WIDGET = () => `Operate widget`;
...
//Joii 导出
export const CONTEXT_EXPORT = () => "Export";
...
export const CREATE_GLOBAL_DIALOG = () => "New global dialog";

//Joii 导入Page
export const IMPORT_PAGE = () => "Import page";
export const IMPORT_AND_OVERWRITE_PAGE = () => "Import and overwrite page";
