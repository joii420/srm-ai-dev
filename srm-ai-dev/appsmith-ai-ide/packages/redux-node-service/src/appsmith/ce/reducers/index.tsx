...
import type { PackagesReduxState } from "@appsmith/reducers/uiReducers/packagesReducer";
import type { ModuleReduxState } from "@appsmith/reducers/uiReducers/moduleReducer";
...
import type { PageItem, PagesReduxState } from "@appsmith/reducers/pagesReducer";
...
export interface AppState {
  ...
  ui: {
    ...
    ide: IDEState;
    packages: PackagesReduxState;
    module: ModuleReduxState;
  };
  entities: {
    canvasWidgetsStructure: CanvasWidgetStructure;
    canvasWidgets: CanvasWidgetsReduxState;
    canvasWidgetsTemp: CanvasWidgetsReduxState;
