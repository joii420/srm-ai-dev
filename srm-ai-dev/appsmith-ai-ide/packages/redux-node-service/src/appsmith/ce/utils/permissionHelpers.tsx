...
export const hasCreateDatasourcePermission = (_permissions?: string[]) => {
  return isPermitted(_permissions, PERMISSION_TYPE.CREATE_DATASOURCES);
};

export const hasManageDatasourcePermission = (_permissions?: string[]) => {
  return isPermitted(_permissions, PERMISSION_TYPE.MANAGE_DATASOURCES);
};

export const hasDeleteDatasourcePermission = (_permissions?: string[]) => {
  return isPermitted(_permissions, PERMISSION_TYPE.DELETE_DATASOURCES);
};
...
//   _permissions?: string[],
// ) => {
//   return isPermitted(_permissions, PERMISSION_TYPE.CREATE_DATASOURCE_ACTIONS);
// };
...
export const hasManagePagePermission = (_permissions?: string[]) => {
  return isPermitted(_permissions, PERMISSION_TYPE.MANAGE_PAGES);
};

export const hasDeletePagePermission = (_permissions?: string[]) => {
  return isPermitted(_permissions, PERMISSION_TYPE.DELETE_PAGES);
};

export const hasCreateActionPermission = (_permissions?: string[]) => {
  return isPermitted(_permissions, PERMISSION_TYPE.CREATE_ACTIONS);
};

export const hasManageActionPermission = (_permissions?: string[]) => {
  return isPermitted(_permissions, PERMISSION_TYPE.MANAGE_ACTIONS);
};

export const hasDeleteActionPermission = (_permissions?: string[]) => {
  return isPermitted(_permissions, PERMISSION_TYPE.DELETE_ACTIONS);
};
